...
- **Fertility & conception (TTC / FAM)** — Log basal body temperature, cervical mucus, LH/ovulation tests, cervix, and intimacy. Luna detects the BBT thermal shift (with coverline), confirms ovulation by cross-checking signs, and shows your fertile window, peak day, implantation window, and a per-day conception-probability curve — goal-aware (trying / avoiding / observing). A charting and awareness tool, **not a contraceptive**.
