...
import { Baby, Bell, BellOff, Check, Flower2, Import, LogOut, Monitor, Moon, Sun } from 'lucide-react';
      ...
      <Card title="Fertility">
        ...
        >
          ...
          <div className="flex-1">
            <p className="font-medium text-ink-900">Fertility &amp; conception</p>
            <p className="text-xs text-ink-500">BBT charting, ovulation, fertile window &amp; more.</p>
          </div>
        </Link>
      </Card>
