      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="font-serif text-xl leading-tight">
            {info.phase === 'menstrual' && 'Rest and replenish'}
            {info.phase === 'follicular' && 'Fresh energy is building'}
            {info.phase === 'ovulation' && 'Peak window'}
            {info.phase === 'luteal' && 'Slowing down gracefully'}
          </p>
        </div>
      </div>
    </section>
